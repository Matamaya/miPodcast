        ...
        <section id="contacto" className="w-full max-w-7xl mx-auto py-24 px-6 md:px-8 relative z-10">
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 w-full">
                ...
                <div className="w-full lg:w-2/3 bg-[#3fec65] rounded-[2rem] p-8 md:p-12 lg:p-16 text-black flex flex-col justify-between shadow-2xl">
                    ...
                    {/* ARIA-LIVE REGION: Anuncia mensajes de error/éxito dinámicamente */}
                    <div
                        aria-live="polite"
                        aria-atomic="true"
                        className={`mb-6 font-medium p-4 rounded-lg transition-opacity ${formStatus.message ? 'opacity-100' : 'opacity-0 hidden'}`}
                        style={{ backgroundColor: formStatus.type === 'error' ? '#ffcccc' : '#ccffcc' }}
                    >
                        {formStatus.message}
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-8 md:gap-12 w-full">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mt-4">
                            <button
                                ...
                                className="group flex items-center justify-between gap-4 border border-black rounded-full py-2 pl-6 pr-2 hover:bg-black hover:text-[#3fec65] transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-[#3fec65]"
                            >
                        ...
                        <div className="z-10 flex items-center justify-between mt-auto">
                            <div className="flex items-center gap-3 text-zinc-400 group-hover:text-white transition-colors">
                                <div className="w-8 h-8 rounded-full bg-zinc-800 flex items-center justify-center text-white">
                                    <svg aria-hidden="true" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                                </div>
